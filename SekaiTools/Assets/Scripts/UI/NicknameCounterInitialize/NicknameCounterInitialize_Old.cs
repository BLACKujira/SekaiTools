...
{
    public class NicknameCounterInitialize_Old : MonoBehaviour
    {
        ...
        public void Apply()
        {
            ...
            {
                NicknameCountMatrix_Ceremony countMatrix = new NicknameCountMatrix_Ceremony(StoryType.LiveTalk,0,null,null);
        ...
        private static NicknameCountMatrix_Scenario GetCountMatrix_Scenario(string file, StoryType storyType,string saveFolder)
        {
            ...
            NicknameCountMatrix_Scenario countMatrix = new NicknameCountMatrix_Scenario(storyType,0,scenarioSceneData);
            countMatrix.fileName = Path.GetFileNameWithoutExtension(file);
